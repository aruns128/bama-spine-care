    ...
    <section id="about" className="section min-height pt-10 pb-5">
      <div className="container">
        ...
        <p className="text-center">
          ...
          Our expertise lies in merging the ancient wisdom of Ayurveda with the
          latest advancements in modern medical technology, ensuring that our
        ...
        <p className="text-center">
          ...
          chronic pain, postural issues, or neurological conditions, we are here
          to guide you towards a pain-free, healthier life.
        </p>
      </div>
    </section>
  );
